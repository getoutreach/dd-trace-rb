...
RSpec.describe 'Tracer integration tests' do
  ...
  describe 'shutdown' do
    ...
    context 'when sent TERM' do
      ...
      it 'gracefully terminates process' do
        expect(terminated_process).to_not be nil
        expect(terminated_process).to_not be_empty
        expect(terminated_process).to eq(graceful_signal)
      end
    end
  end
